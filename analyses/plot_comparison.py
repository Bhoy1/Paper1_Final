...
# Automatically find all CSV files in 7.a and 7.b folders
alter_gru_files = sorted(glob(r'C:\Users\billy\Desktop\Paper1_Final\analyses\2\2.a\*.csv'))
normal_gru_files = sorted(glob(r'C:\Users\billy\Desktop\Paper1_Final\analyses\2\2.b\*.csv'))
