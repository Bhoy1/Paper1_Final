#FINAL: this one includes the belief loss 
...
#7/28, this version is for getting rid of the loss function that the old commit did by accident but it worked 
...
class Config:
    ...
    gate_width: int = 64           # Width of the surprise gate MLP
    belief_loss_coef: float = 0.05  # Coefficient for predictor loss
    ...
    belief_warmup_epochs: int = 10 #number of warmup epochs 
    ...
    grad_clip_norm: float = 1          # Gradient clipping, myabe try 1 or 3 here
    scratch_clip_value: float = 10.0      # Scratch memory clipping
